                    ...
                    <div class="hidden lg:flex justify-between mb-6">
                        ...
                        <div class="space-x-2">
                            <Link
                                ...
                                >{{ singlePost.category.title }}</Link
                            >
                        </div>
                    </div>
                    ...
                    <div class="mt-10 'border border-gray-200 p-6 rounded-xl">
                        <form class="m-auto" @submit.prevent="submitComment">
                            ...
                            <div class="mt-6">
                                ...
                                <span class="text-xs text-red-500">{{$page.props.errors.body}}</span>
                            </div>

                            <div
                                class="flex mb-6 justify-end mt-6 pt-6 border-t border-gray-200"
                            >
                        ...
                        <comment
                            v-for="comment in singlePost.comment"
                            :comment="comment"
                            :key="comment.id"
                        />
                    </div>
