...
<template>
    <main>
        <nav
            class="card-bg p-4 card-border lg:grid grid-cols-2 lg:gap-10 justify-items-around"
        >
            <div>
                <h1>
...
messages
            ...
            <div class="bg-gray-200 card-border lg:col-span-4 overflow-scroll max-h-screen ">
